"""
Django settings for SphinxBot project.
...
SECRET_KEY = '+j1_#h^oc3s@k8erhye)eg$qztu@=#xyj_@w!w&r7#^mzd7r-0'
...
WSGI_APPLICATION = 'SphinxBot.wsgi.application'
